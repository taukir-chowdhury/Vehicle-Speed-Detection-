...
ENTRY_LINE = Line(area_processed[0], area_processed[1])
EXIT_LINE = Line(area_processed[2], area_processed[3])
...
while True:
    ...
    if success:
        ...
        cv2.polylines(frame,[np.array([area_processed[0], area_processed[1]], np.int32)], True, (15, 220, 18), 6)
        cv2.polylines(frame,[np.array([area_processed[2], area_processed[3]], np.int32)], True, (15, 220, 18), 6)
